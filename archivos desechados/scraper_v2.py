...
# That version of the script scrapes multiple pages from Bumeran Argentina for job listings in the technology sector.
# I take off the date of the posting of the jobs.
# Now, I can specify how many pages I want to scrape.
...
total_pages = 29  # Por ejemplo, las primeras 29 páginas

for page in range(1, total_pages + 1):
    if page == 1:
        url = "https://www.bumeran.com.ar/empleos-area-tecnologia-sistemas-y-telecomunicaciones.html"
    else:
        url = f"https://www.bumeran.com.ar/empleos-area-tecnologia-sistemas-y-telecomunicaciones.html?page={page}"
...
df.to_csv("bumeran_jobs_multipagina.csv", index=False)
